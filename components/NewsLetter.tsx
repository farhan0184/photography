                    ...
                    <div className='mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2 '>
                        <div className='max-w-xl lg:max-w-lg'>
                            ...
                            <Fade direction='up' delay={600} cascade damping={1e-1} triggerOnce={true}>
                                <p className='mt-4 text-lg leading-8 subtitile'>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system.</p>
                            </Fade>
                            ...
                            <div className='flex flex-col items-start'>
                                ...
                                <Fade direction='up' delay={800} cascade damping={1e-1} triggerOnce={true}>
                                    <dd className='mt-2 leading-7'>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit dolor, ratione maxime molestiae.
                                    </dd>
                                </Fade>
                            </div>
